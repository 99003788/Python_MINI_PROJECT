...
class accept_value:
    ...
    @staticmethod
    def take_value():  # creating a method to accept input from the user
...
class main(accept_value):
    ...
    def my_func():
        ...
        data_input = accept_value.take_value()  # invoking the extract method
        new_row_index = 1
        new_summary_index = 1
        position = 0
        count_column = 0
        ...
        count_row = master_sheet.max_row  # Counting maximum number of rows in master sheet
        count_column = master_sheet.max_column - 1  # Counting maximum number of columns in master sheet
        ...
        new_summary_index += 1
        summary_sheet.cell(row=2, column=1).value = count_row  # Number of rows in the master sheet
        summary_sheet.cell(row=2, column=2).value = count_column  # Number of columns in the master sheet
